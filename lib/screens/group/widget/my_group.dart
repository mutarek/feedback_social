  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text( getTranslated("MY group", context),style: latoStyle800ExtraBold,),
                    ...
                    return InkWell(
                      ...
                      child: ListTile(
                          leading: CircleAvatar(
                            ...
                            backgroundImage:
                            NetworkImage(groupProvider.authorGroupList[index].coverPhoto),
                          ),
                          trailing: Container(
                            height: height * 0.027,
                            width: width * 0.15,
                          ...
                          title: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  "${groupProvider.authorGroupList[index].totalMember.toString()} ${getTranslated("Followers", context)}",
