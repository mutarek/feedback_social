  ...
  Widget build(BuildContext context) {
    return Consumer<GroupProvider>(
        builder: (context, groupProvider, child) => InkWell(
              onTap: () {
                groupProvider.trackJoinGroup(0);
                Helper.toScreen(GroupDetailsPage(authorGroupModel.id.toString(), index: index));
              },
              child: Card(
                elevation: 1,
                child: Column(
                        ...
                        children: [
                          Expanded(
                            child: InkWell(
                              onTap: () {
                                groupProvider.trackJoinGroup(0);
                                groupProvider.memberJoin(int.parse(authorGroupModel.id.toString()), index: index);
                              },
                              child: Container(
                                height: 25,
