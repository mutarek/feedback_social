            ...
            widget,
              ...
              Align(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(left: 18),
                  child: Text(
                    groupProvider.groupDetailsModel.bio!,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(groupProvider.groupDetailsModel.isPrivate==true?"Private":"Public", style: robotoStyle800ExtraBold.copyWith(fontSize: 15, color: AppColors.primaryColorLight)),
                        ...
                        children: [
                          ...
                          Text.rich(
                            TextSpan(
                              children: [
                                TextSpan(
                                    text: groupProvider.groupDetailsModel.address,
                    ...
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                              text:
                              groupProvider.groupDetailsModel.description,
