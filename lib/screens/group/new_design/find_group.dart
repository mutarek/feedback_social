...
class _FindGroupState extends State<FindGroup> {
  ...
  @override
  void initState() {
    Provider.of<GroupProvider>(context, listen: false).findPage();
    controller.addListener(() {
      if (controller.offset >= controller.position.maxScrollExtent &&
          !controller.position.outOfRange &&
          Provider.of<GroupProvider>(context, listen: false).hasNextData) {
        Provider.of<GroupProvider>(context, listen: false).updateFindPageNo();
      }
    });
                ...
                children: [
                        ...
                        children: [
                           Expanded(
                            child: TextField(
                              ...
                              decoration:
                              const InputDecoration(border: InputBorder.none, hintText: "Search..", hintStyle: TextStyle(color: Colors.black)),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: InkWell(
                                  ...
                                  groupProvider.findPage(groupName: textController.text);},
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount: groupProvider.findGroupModel.length,
                      itemBuilder: (_,index){
                        return Card(
                          elevation: 1,
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        ...
                                        child: SizedBox(
                                          height: 36,
                                            width: 36,
                                            child: customNetworkImage(groupProvider.findGroupModel[index].coverPhoto,height: 36,boxFit: BoxFit.fitWidth))
                                      ),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          Text(groupProvider.findGroupModel[index].name,style: robotoStyle700Bold.copyWith(fontSize: 15,color: AppColors.primaryColorLight)),
                                          Row(
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(groupProvider.findGroupModel[index].coverPhoto, style: robotoStyle500Medium.copyWith(fontSize: 9)),
                                                ],
                                              )
                                            ],
                                          )
                                                      ...
                                                      PopupMenuItem(
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            PopUpMenuWidget(ImagesModel.copyIcons, 'Copy Link', () { Clipboard.setData(ClipboardData(text: groupProvider.findGroupModel[index].copyLinkUrl));},isShowAssetImage: false,),
                                                          ],
                                                        ),
                                                      ),
                                                      // PopupMenuItem 2
