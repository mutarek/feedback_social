                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: const InputDecoration(
                              border: InputBorder.none, hintText: "Search..", hintStyle: TextStyle(color: Colors.black)),
                        ),
                      ),
                      Padding(
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                      ...
                                      child: SizedBox(
                                          height: 36,
                                          width: 36,
                                          child: customNetworkImage(groupProvider.findGroupModel[index].coverPhoto,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(groupProvider.findGroupModel[index].name,
                                          style: robotoStyle700Bold.copyWith(fontSize: 15, color: AppColors.primaryColorLight)),
                                      Row(
                                        children: [
                                          Text(
                                            '570K Members - 10+ Post a Day',
                                            style: robotoStyle500Medium.copyWith(fontSize: 10, color: AppColors.primaryColorLight),
                                          ),
                                          const SizedBox(
                                            width: 10,
                                          ),
                                          Row(
                                            children: [
                                              ...
                                              Text(groupProvider.findGroupModel[index].coverPhoto,
                                          ...
                                          children: [
                                            ...
                                            Text(index % 2 == 0 ? "Join Group" : "Joined",
                                                style: robotoStyle700Bold.copyWith(
                                                    fontSize: 15, color: index % 2 == 0 ? AppColors.primaryColorLight : Colors.white))
                                          ],
                                        ),
                                      ),
                                    ),
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            PopUpMenuWidget(
                                                              ...
                                                              () {
                                                                Clipboard.setData(
                                                                    ClipboardData(text: groupProvider.findGroupModel[index].copyLinkUrl));
                                                              },
                                                              isShowAssetImage: false,
                                                            ),
                                                          ],
