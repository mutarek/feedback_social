...
class SinglePostScreen1 extends StatefulWidget {
  ...
  const SinglePostScreen1(this.url,
                                    ...
                                    InkWell(
                                      ...
                                      child: SizedBox(
                                        ...
                                        child: Stack(
                                          ...
                                          children: [
                                            Icon(
                                                (newsFeedProvider.singleNewsFeedModel.reaction == true)
                                                    ? Icons.favorite
                                                    : Icons.favorite_border,
                                                size: 30,
                                                color: (newsFeedProvider.singleNewsFeedModel.reaction == true) ? Colors.red : Colors.black),
                                          ],
                                        ),
                                      ),
                                    ),
