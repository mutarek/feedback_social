              ...
              children: [
                ...
                newsFeedData.description != null && newsFeedData.description!.isNotEmpty && newsFeedData.description!.contains("http")
                    ? MarkdownBody(
                        ...
                        styleSheet: MarkdownStyleSheet(a: const TextStyle(fontSize: 17), p: latoStyle500Medium),
                      )
                    : const SizedBox(),
                                    ...
                                    children: [
                                      ...
                                      newsFeedData.sharePost!.shareFrom == 'group'
                                          ? InkWell(
                                              ...
                                              child: Text(newsFeedData.sharePost!.post!.author!.fullName! + LocaleKeys.posted_Here.tr(),
