          ...
          child: SingleChildScrollView(
            child: Consumer<ProfileProvider>(
              builder: (context,provider,child) {
                return  provider.isLoading?Center(child: CupertinoActivityIndicator()):Column(
...
SizedBox(height: 20,),
                    ...
                    SizedBox(height: 40,),
                    Text("Settings",style:GoogleFonts.lato(fontSize: 40,fontWeight: FontWeight.w800),),
                    SizedBox(height: 40,),
                    Text("Accounts",style:GoogleFonts.lato(fontSize: 20,fontWeight: FontWeight.w400),),
                    SizedBox(height: 40,),
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column( mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(provider.userprofileData.firstName!+provider.userprofileData.lastName!,style: GoogleFonts.lato(fontSize: 16)),
                              SizedBox(height: 2,),
                              Text("personal info",style: GoogleFonts.lato(color: Color(0xff9C9EA2)),)
                            ],
                          ),
                        ),
                        Spacer(),
                    ...
                    SizedBox(height: 40,),
                    Text("Settings",style:GoogleFonts.lato(fontSize: 20,fontWeight: FontWeight.w400),),
                    SizedBox(height: 20,),
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          ...
                          child: Center(child: SvgPicture.asset("assets/svg/darkmode.svg",height: 15,color: Colors.blue,)),
                        ),
                        SizedBox(width: 10,),
