        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: const Center(child: Text("My page", style: TextStyle(color: Colors.white))),
                ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(4), color: Colors.white, border: Border.all(color: Colors.black, width: 1)),
            ...
            Padding(
              ...
              child: Row(
                children: const [
                  Text("My pages", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  Spacer(),
                  Padding(
                    padding: EdgeInsets.only(top: 5),
                    child: Text("See all", style: TextStyle(fontSize: 10, color: Colors.black54)),
                  ),
                ],
              ),
            ),
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const Text("Page name", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                              const SizedBox(height: 2),
                              const Text("5908 likes", style: TextStyle(color: Colors.black26, fontSize: 10)),
                            ],
                          )
                        ],
                      );
            ...
            Padding(
              ...
              child: Row(
                children: const [
                  Text("Page you liked", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  Spacer(),
                  Padding(padding: EdgeInsets.only(top: 5), child: Text("See all", style: TextStyle(fontSize: 10, color: Colors.black54))),
                ],
              ),
            ),
            SizedBox(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ListTile(
                        leading: const CircleAvatar(radius: 24, backgroundColor: Colors.black12),
                        trailing: Container(
                          height: height * 0.027,
                          width: width * 0.15,
                          decoration: BoxDecoration(color: const Color(0xff090D2A), borderRadius: BorderRadius.circular(4)),
