...
class PageCommentView extends StatelessWidget {
  const PageCommentView(
      {Key? key, required this.value, required this.showDescription, required this.description})
      : super(key: key);
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                        image: AssetImage("assets/background/help.png"), fit: BoxFit.cover))
            ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(child: SvgPicture.asset(
                      "assets/svg/like.svg", fit: BoxFit.cover, height: 9, width: 8)),
                ),
                Positioned(
                  left: 14,
                  child: Container(
                    ...
                    child: Center(child: SvgPicture.asset(
                        "assets/svg/love.svg", fit: BoxFit.cover, height: 9, width: 8)),
                  ),
                ),
                Positioned(
                  left: 28,
                  child: Container(
                    ...
                    child: Center(child: SvgPicture.asset(
                        "assets/svg/haha.svg", fit: BoxFit.cover, height: 9, width: 8)),
                  ),
                ),
              ],
            ),
            RichText(
                text: TextSpan(text: "Rafatul ",
                            ...
                            TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: " others",
                                    style: GoogleFonts.roboto(
                                        fontWeight: FontWeight.w400, fontSize: 12, color: AppColors
                                        .primaryColorLight),
                                  ),
                                ])
                          ])
              ...
              children: [
                Container(
                    ...
                    decoration: const BoxDecoration(
                        shape: BoxShape.circle, color: AppColors.primaryColorLight),
                    child: Center(child: SvgPicture.asset(
                        "assets/svg/comment.svg", fit: BoxFit.cover, height: 9, width: 8))),
                const SizedBox(width: 3),
                Text(
                  "120",
                  style: GoogleFonts.roboto(
              ...
              children: [
                Container(
                    ...
                    decoration: const BoxDecoration(
                        shape: BoxShape.circle, color: AppColors.primaryColorLight),
                    child: Center(child: SvgPicture.asset(
                        "assets/svg/share2.svg", fit: BoxFit.cover, height: 9, width: 8))),
                const SizedBox(width: 3),
                Text(
                  "90",
                  style: GoogleFonts.roboto(
              ...
              [
                ...
                PopupMenuItem(
                  child: Column(
                    ...
                    children: [
                      PopUpMenuWidget(
                          ImagesModel.shareTimelinesIcons, 'Share on your timeline', () {},
                          size: 18),
                      const SizedBox(height: 18),
                      PopUpMenuWidget(
                          ImagesModel.shareMessageIcons, 'Share via message', () {}, size: 18),
                      const SizedBox(height: 18),
                      PopUpMenuWidget(
                          ImagesModel.shareFriendIcons, 'Share to friends timeline', () {},
                          size: 16),
                      const SizedBox(height: 18),
                      PopUpMenuWidget(
                          ImagesModel.shareGroupIcons, 'Share to a group', () {}, size: 16),
                      const SizedBox(height: 18),
                      PopUpMenuWidget(ImagesModel.pageIconsPng, 'Share to a page', () {}, size: 18,
                          isShowAssetImage: true),
                      const SizedBox(height: 10),
                    ],
                  ),
                ),
              ...
              child: Row(
                children: [
                  Container(
                    height: 23,
                    width: 37,
                    decoration: BoxDecoration(color: AppColors.primaryColorLight,
                        borderRadius: BorderRadius.circular(18)),
                    child: Padding(
                        padding: const EdgeInsets.all(4.0),
                        child: SvgPicture.asset(
                            ImagesModel.share2Icons, height: 13, width: 12, color: Colors.white)),
                  ),
    ...
    child: Row(
      children: [
        Container(
          ...
          width: 37,
          decoration: BoxDecoration(
              color: AppColors.primaryColorLight, borderRadius: BorderRadius.circular(18)),
          child: Padding(padding: const EdgeInsets.all(4.0),
              child: SvgPicture.asset(image, height: 13, width: 12, color: Colors.white)),
        ),
        const SizedBox(width: 5),
