  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: Consumer6<
          UserProfileProvider, UpdateProfileImageProvider,PostImagesPreviewProvider,
                  UpdateCoverPhotProvider, ProfileImagesProvider, UserNewsfeedPostProvider>(
              builder: (context, provider, profileImageProvider,
                  postImageProvider,
                  coverPhotoProvider, profileImages, userPostProvider, child) {
                                                                      ...
                                                                      child: (userPostProvider.authorPostResults[index].totalImage! >
                                                                          ...
                                                                          ? Container(
                                                                              ...
                                                                              decoration: BoxDecoration(
                                                                                ...
                                                                                image:
                                                                                    NetworkImage(userPostProvider.authorPostResults[index].images![index2].image!),
                                                                                fit:
                                                                                    BoxFit.cover,
                                                                              )),
                                                                            )
