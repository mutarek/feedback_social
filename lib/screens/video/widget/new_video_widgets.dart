            ...
            Padding(
                ...
                child: widget.model.isPage == true
                    ? Row(
                        ...
                        children: [
                          ProfileAvatar(profileImageUrl: widget.model.page!.avatar.toString()),
                    ...
                    : widget.model.isGroup == true
                        ? Row(
                            ...
                            children: [
                              InkWell(
                                  onTap: () async {
                                    await videoPlayerController!.pause();
                                    Helper.toScreen(PublicGroupScreen(widget.model.group!.id.toString(), index: 1));
                                  },
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      child: Row(
                                        children: [
                                          const SizedBox(width: 5),
                                          Text(widget.model.group!.name.toString(),
                                              style: latoStyle500Medium.copyWith(fontWeight: FontWeight.w600)),
                                          const SizedBox(width: 5),
                                        ],
                                      ),
                        ...
                        : Row(
                            ...
                            children: [
                              InkWell(
                                  onTap: () async {
                                    if (Provider.of<AuthProvider>(context, listen: false).userID == widget.model.user!.id.toString()) {
                                      Navigator.of(context).push(MaterialPageRoute(builder: (_) => const ProfileScreen()));
                                    } else {
                                      Navigator.of(context)
                                          .push(MaterialPageRoute(builder: (_) => PublicProfileScreen(widget.model.user!.id.toString())));
                                    }
                                    await videoPlayerController!.pause();
                                  },
                                      ...
                                      onTap: () async {
                                        if (Provider.of<AuthProvider>(context, listen: false).userID == widget.model.user!.id.toString()) {
                                          ...
                                          Navigator.of(context).push(
                                              MaterialPageRoute(builder: (_) => PublicProfileScreen(widget.model.user!.id.toString())));
                                        }
