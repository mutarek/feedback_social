          ...
          child: SingleChildScrollView(
            ...
            Padding(
              ...
              child: Container(
                  ...
                  child: Consumer<CreatePageProvider>(builder: (context, provider, child) {
                    return Padding(
                          ...
                          Container(
                            ...
                            child: Center(
                              child: DropdownButton<String>(
                                dropdownColor: const Color.fromARGB(255, 248, 245, 245),
            ...
            Padding(
              padding: EdgeInsets.only(top: height * 0.03, left: width * 0.17),
              child: Container(
                width: width * 0.7,
                decoration: BoxDecoration(color: const Color(0xffEBF5FF), borderRadius: BorderRadius.circular(5)),
                child: TextFormField(
                  controller: pageNameController,
                  textAlign: TextAlign.center,
                  decoration: InputDecoration(
                    contentPadding: const EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0),
                    border: const OutlineInputBorder(borderSide: const BorderSide(color: Colors.green)),
            ...
            Consumer<CreatePageProvider>(builder: (context, provider, child) {
              return Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (pageNameController.text.isEmpty) {
                        Fluttertoast.showToast(msg: "Please fill all ther form");
                      } else {
                        provider.createpage(
                    ...
                    child: Container(
                        ...
                        child: Center(child: Text("Submit", style: GoogleFonts.lato(fontWeight: FontWeight.w400, color: Colors.white)))),
                  ),
                ),
              );
            }),
